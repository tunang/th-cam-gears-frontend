...
/* Primary Sans-Serif */
--p-font-family-sans:
  "Inter", -apple-system, BlinkMacSystemFont, "San Francisco", "Segoe UI",
...
.button {
  transition:
    background var(--p-motion-duration-100) var(--p-motion-ease),
...
.card-interactive {
  transition:
    box-shadow var(--p-motion-duration-200) var(--p-motion-ease),
...
.component:focus-within {
  box-shadow:
    0 0 0 2px var(--p-color-bg-surface),
