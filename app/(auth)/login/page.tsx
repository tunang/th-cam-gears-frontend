...
function LoginPageContent() {
  ...
  return (
    <div style={{ animation: 'fade-in var(--p-motion-duration-300) var(--p-motion-ease)' }}>
      {/* Logo / Branding */}
      ...
      >
        ...
        {showRegisteredBanner && (
          ...
          >
            ...
            <span>Đăng ký thành công! Kiểm tra email để xác minh tài khoản, sau đó đăng nhập.</span>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
          ...
          <div>
            ...
            />
            {errors.email && (
              <p className="mt-1 text-xs" style={{ color: 'var(--p-color-text-critical)' }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!isLoading) e.currentTarget.style.background = 'var(--p-color-bg-fill-brand-hover)';
            }}
            onMouseLeave={(e) => {
        ...
        <div className="relative my-5">
          <div className="absolute inset-0 flex items-center" aria-hidden="true">
            <div className="w-full" style={{ borderTop: '1px solid var(--p-color-border-secondary)' }} />
          </div>
          <div className="relative flex justify-center text-xs">
            <span className="px-3" style={{ background: 'var(--p-color-bg-surface)', color: 'var(--p-color-text-secondary)' }}>
              hoặc
            </span>
          </div>
        </div>
      ...
      {/* Register link */}
      <p className="mt-6 text-center text-sm" style={{ color: 'var(--p-color-text-secondary)' }}>
        Chưa có tài khoản?{' '}
        <Link
          href="/register"
